...
public class TrackingGame {
    ...
    private static void puzzle1() {
        ...
        for (int i = 0; i < transmission.length() - 16; i++) {
            String bla = new String(decoder.decode(transmission.substring(i, i + 16)));
            if (containsValidChars(bla)) {
