  ...
  def solvePart2(lines: List[String]): Long = {
    ...
    for (line <- lines) {
      line match {
        ...
        case COUNTER_CLOCKWISE() => waypoint = (-waypoint._2, waypoint._1)
        case CLOCKWISE() => waypoint = (waypoint._2, -waypoint._1)
        case REVERSE() => waypoint = (-waypoint._1, -waypoint._2)
        case F(f) => pos = (pos._1 + waypoint._1 * f.toInt, pos._2 + waypoint._2 * f.toInt)
      }
    }
    Math.abs(pos._1) + Math.abs(pos._2)
  }
...
object Day12 extends App {
  new Day12().solvePuzzles("/2020/input-puzzle12.txt")
}
